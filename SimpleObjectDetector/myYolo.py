# Tutorial: https://pysource.com/2019/06/27/yolo-object-detection-using-opencv-with-python/
...
if (img.shape[1] > 1500):
	img = cv2.resize(img, None, fx=(1500 / img.shape[1]), fy=(1500 / img.shape[1]))
elif (img.shape[0] > 800):
	img = cv2.resize(img, None, fx=(800 / img.shape[0]), fy=(800 / img.shape[0]))
